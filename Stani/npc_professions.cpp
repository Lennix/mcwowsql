    ...
    if (uiAction)
    {
        ...
        switch(eCreature)
        {
            ...
            case 11191:
				...
				pPlayer->SEND_GOSSIP_MENU(22992, pCreature->GetGUID());
                break;
            case 11192:
            ...
            case 11193:
                ...
                pPlayer->removeSpell(S_SWORD);                                            //unknown textID (TALK_SWORD_UNLEARN)
                pPlayer->SEND_GOSSIP_MENU(22992, pCreature->GetGUID());
                break;
        }
    }
