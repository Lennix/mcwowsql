...
-- Zandalar Tribe 
UPDATE `item_template` SET `RequiredReputationRank`='0' WHERE `entry`='20031'; 
UPDATE `item_template` SET `RequiredReputationRank`='0' WHERE `entry` IN (20080, 20079, 20081); 
UPDATE `item_template` SET `RequiredReputationRank`='0' WHERE `entry` IN (20077, 20076, 20078); 
